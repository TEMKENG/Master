...
export class Canvas implements ShapeManager {
    ...
    constructor(canvasDomElement: HTMLCanvasElement,
        ...
        function addShapeEvent(shapeId: number, shapeDate: { [p: string]: any }) {
        ...
        function removeShapeWithIdEvent(shapeId: number) {
        ...
        function selectShapeEvent(shapeId: number, clientId: number) {
        ...
        function unselectShape(shapeId: number, clientId: number) {
        ...
        canvasDomElement.addEventListener("removeShapeWithId", function (e: CustomEvent) {
    ...
    chooseShapeAt(x: number, y: number, selected: boolean = false, toSelect?: { [p: number]: Shape }) {
        // this.selectShapes = [];
