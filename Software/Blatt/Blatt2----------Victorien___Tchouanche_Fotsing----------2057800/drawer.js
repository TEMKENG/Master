...
var canvasWidth = 700, canvasHeight = 500;
var Selected = 'Selected';
var SelectedColor = 'rgb(33, 230, 89)';
var Hover = 'Hover';
var HoverColor = 'rgb(16, 114, 44)';
...
var Circle = /** @class */ (function (_super) {
    ...
    Circle.prototype.checkCollision = function (x, y) {
...
var Rectangle = /** @class */ (function (_super) {
    ...
    Rectangle.prototype.checkCollision = function (x, y) {
...
var Triangle = /** @class */ (function (_super) {
    ...
    Triangle.prototype.checkCollision = function (x, y) {
        var b1 = this.checkSign(x, y, this.p1, this.p2) < 0;
        var b2 = this.checkSign(x, y, this.p2, this.p3) < 0;
        var b3 = this.checkSign(x, y, this.p3, this.p1) < 0;
        return ((b1 === b2) && (b2 === b3));
    };
    return Triangle;
}(AbstractShape));
